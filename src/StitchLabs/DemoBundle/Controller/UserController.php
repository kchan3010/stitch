...
use StitchLabs\DemoBundle\Entity\Organisation;
use StitchLabs\DemoBundle\Entity\User;
use StitchLabs\DemoBundle\Form\UserType;
...
class UserController extends FOSRestController implements ClassResourceInterface
{
    ...
    public function cgetAction(Request $request, $organisationId)
    {
        ...
        $entities = $em->getRepository('StitchLabsDemoBundle:User')->findBy(
            array(
    ...
    protected function getEntity($organisationId, $id)
    {
        ...
        $entity = $em->getRepository('StitchLabsDemoBundle:User')->findOneBy(
            array(
                'id' => $id,
                'organisation' => $organisationId,
            )
    ...
    protected function getOrganisation($id)
    {
        ...
        $entity = $em->getRepository('StitchLabsDemoBundle:Organisation')->find($id);
